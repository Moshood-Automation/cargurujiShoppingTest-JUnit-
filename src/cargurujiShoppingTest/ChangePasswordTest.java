	...
	public int random;
	 ...
	 @Before
	   ...
	   // THIS WILL PRINT OUT LIST OF ALL HIDDEN WEBELEMENT IN A DROP DOWN FIELD
          ...
          driver.findElement(By.cssSelector("input#old_passwd")).sendKeys("Isaac");
          driver.findElement(By.cssSelector("input#passwd")).sendKeys("Isaac123");
          driver.findElement(By.cssSelector("input#confirmation")).sendKeys("Isaac123");
	      ...
	      String ActualText = driver.findElement(By.cssSelector("p.alert")).getText();
